...
<div class="container card-content my-5">
	...
	<div class="row input-textarea">
		<div class="col-12">
			<div class="form-floating">
				<textarea class="form-control" placeholder="Type your spanish text" id="spanish_text" style="height: 10rem"></textarea>
				<label for="spanish_text">Type your spanish text</label>
			</div>
		</div>
	</div>
	...
	<div class="row change-icon text-center py-4">
		<div class="col-12">
			<a href="{{ route('english_to_spanish') }}"><i class="fa-solid fa-arrow-right-arrow-left p-2"></i></a>
		</div>
	</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#spanish_text').on('keyup', function() {
			//Assigning search box value to javascript variable named as "name".
			var target_url = "{{ route('translate') }}";
			var spanish_text = $('#spanish_text').val();
