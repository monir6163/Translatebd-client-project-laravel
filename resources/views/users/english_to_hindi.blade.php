...
<div class="container card-content my-5">
	...
	<div class="row input-textarea">
		<div class="col-12">
			<div class="form-floating">
				<textarea class="form-control" placeholder="Your hindi text" id="hindi_text" style="height: 10rem"></textarea>
				<label for="hindi_text">Your hindi text</label>
			</div>
		</div>
	</div>
