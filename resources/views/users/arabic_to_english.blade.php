...
<div class="container card-content my-5">
	...
	<div class="row input-textarea">
		<div class="col-12">
			<div class="form-floating">
				...
				<label for="arabic_text">Type your arabic text</label>
			</div>
		</div>
	</div>
	...
	<div class="row change-icon text-center py-4">
		<div class="col-12">
			<a href="{{ route('english_to_arabic') }}"><i class="fa-solid fa-arrow-right-arrow-left p-2"></i></a>
		</div>
	</div>
